...
const Post = () => {
  ...
  return (
    <Layout>
      <div
        className="min-h-screen p-4 bg-cover bg-center flex items-center justify-center bg-white dark:bg-gray-900"
        style={{ backgroundImage: `url(${backgroundImg})` }}
      >
        <form
          onSubmit={handleSubmit(onSubmit)}
          className="w-full max-w-xl mx-auto p-6 rounded-lg shadow-md bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm border border-transparent dark:border-white/20"
        >
          <h1 className="mb-4 text-3xl font-semibold text-center text-gray-800 dark:text-gray-200">
